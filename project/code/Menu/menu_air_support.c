...
static const menu_air_param_definition_t s_air_param_definitions[] =
{
    ...
    MENU_AIR_PARAM(mode7_vel_x_kd, 0.0f,      0.0005f,  0.0f, 3000.0f, "Mode7"),
    ...
    MENU_AIR_PARAM(mode7_vel_y_kd, 0.0f,      0.0005f,  0.0f, 3000.0f, "Mode7"),
    ...
    MENU_AIR_PARAM(mode5_img_x_kp, 2.2f,      0.1f, 0.0f, 10.0f, "Mode5"),
    ...
    MENU_AIR_PARAM(mode5_img_y_kp, 2.2f,      0.1f, 0.0f, 10.0f, "Mode5"),
    ...
    MENU_AIR_PARAM(mode5_kp_car_x, 45.0f, 5.0f, 0.0f, 100.0f, "Mode5"),
    MENU_AIR_PARAM(mode5_kp_car_y, 45.0f, 5.0f, 0.0f, 100.0f, "Mode5"),

    MENU_AIR_PARAM(mode8_img_x_kp, 2.4f,      0.1f, 0.0f, 10.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_ki, 0.0f,      0.1f, 0.0f, 10.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_kd, 0.0f,      0.1f, 0.0f, 10.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_kff, 0.0f,     0.1f, 0.0f, 10.0f, "Mode8 Img"),
    ...
    MENU_AIR_PARAM(mode8_kp_car_x, 20.0f, 5.0f, 0.0f, 100.0f, "Mode8 Vel"),
    ...
    MENU_AIR_PARAM(mode2_vel_x_kp, 0.2f, 0.01f, 0.0f, 0.5f, "Mode2 Vel"),
    ...
    MENU_AIR_PARAM(mode2_kp_car_x, 50.0f, 5.0f, 0.0f, 100.0f, "Mode2 Vel"),
    MENU_AIR_PARAM(mode2_kp_car_y, 65.0f, 5.0f, 0.0f, 100.0f, "Mode2 Vel"),
    ...
    MENU_AIR_PARAM(mode4_img_x_kp2, 0.1f,     0.1f, 0.0f, 3.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_img_x_ki, 0.0f,      0.1f, 0.0f, 10.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_img_x_kd, 0.0f,      0.1f, 0.0f, 10.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_img_x_kff, 0.0f,     0.1f, 0.0f, 10.0f, "Mode4 Img"),
    ...
    MENU_AIR_PARAM(mode4_img_y_kp2, 0.1f,     0.1f, 0.0f, 3.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_img_y_ki, 0.0f,      0.01f, 0.0f, 3000.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_img_y_kd, 0.0f,      0.01f, 0.0f, 3000.0f, "Mode4 Img"),
    ...
    MENU_AIR_PARAM(mode4_kp_car_x, 50.0f, 5.0f, 0.0f, 100.0f, "Mode4 Vel"),
    MENU_AIR_PARAM(mode4_kp_car_y, 65.0f, 5.0f, 0.0f, 100.0f, "Mode4 Vel"),
