...
static const menu_air_param_definition_t s_air_param_definitions[] =
{
    ...
    MENU_AIR_PARAM(mode3_img_x_kp2, 0.1f,     0.1f, 0.0f, 3.0f, "Mode3 Img"),
    ...
    MENU_AIR_PARAM(mode3_img_y_kp2, 0.1f,     0.1f, 0.0f, 3.0f, "Mode3 Img"),
    ...
    MENU_AIR_PARAM(mode3_kp_car_x, 50.0f, 5.0f, 0.0f, 100.0f, "Mode3 Img"),
