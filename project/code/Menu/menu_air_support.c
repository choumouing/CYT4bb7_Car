...
static const menu_air_param_definition_t s_air_param_definitions[] =
{
    ...
    MENU_AIR_PARAM(vel_xy_dt, 0.01f,           0.001f,   0.0001f, 0.2f,    "Basic"),
    ...
    MENU_AIR_OPTIONAL_PARAM(c1_confirm, 4.0f, 1.0f, 1.0f, 255.0f, "Core1 Tracking"),
    MENU_AIR_OPTIONAL_PARAM(c1_misses, 6.0f, 1.0f, 0.0f, 255.0f, "Core1 Tracking"),
    MENU_AIR_OPTIONAL_PARAM(c1_pos_alpha, 0.408392f, 0.01f, 0.0f, 1.0f, "Core1 Tracking"),
    MENU_AIR_OPTIONAL_PARAM(c1_vel_alpha, 0.163340f, 0.01f, 0.0f, 1.0f, "Core1 Tracking"),
    ...
    MENU_AIR_OPTIONAL_PARAM(bl3_confirm, 4.0f, 1.0f, 1.0f, 255.0f, "2BL3 Tracking"),
    MENU_AIR_OPTIONAL_PARAM(bl3_misses, 6.0f, 1.0f, 0.0f, 255.0f, "2BL3 Tracking"),
    MENU_AIR_OPTIONAL_PARAM(bl3_pos_alpha, 0.408392f, 0.01f, 0.0f, 1.0f, "2BL3 Tracking"),
    MENU_AIR_OPTIONAL_PARAM(bl3_vel_alpha, 0.163340f, 0.01f, 0.0f, 1.0f, "2BL3 Tracking"),
