...
extern float mode2_forward_mid_threshold_px;
extern float mode2_forward_far_threshold_px;
extern float mode2_forward_near_speed_mps;
extern float mode2_forward_mid_speed_mps;
extern float mode2_forward_far_speed_mps;
extern float mode2_strafe_mid_threshold_px;
extern float mode2_strafe_far_threshold_px;
extern float mode2_strafe_near_speed_mps;
extern float mode2_strafe_mid_speed_mps;
extern float mode2_strafe_far_speed_mps;
