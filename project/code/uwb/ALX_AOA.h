...
#define ALX_AOA_MEDIAN_SIZE                (5U)
#define ALX_AOA_OBS_STEP_GATE_CM           (12.0f)
#define ALX_AOA_REACQUIRE_COUNT            (12U)
#define ALX_AOA_REACQUIRE_STABLE_CM        (8.0f)
#define ALX_AOA_LPF_CUTOFF_HZ              (1.5f)
#define ALX_AOA_OUTPUT_SLEW_CM_S           (80.0f)
