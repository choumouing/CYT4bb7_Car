...
void car_mode3_update_100HZ(uint32 now_ms)
{
    ...
    {
        g_car_mode3_state.raw_forward_mps = car_math_limit_absf(g_air_car_plan_forward_mps,
                                                                MODE3_MAX_VELOCITY_MPS);
        g_car_mode3_state.raw_strafe_mps = car_math_limit_absf(g_air_car_plan_strafe_mps,
                                                               MODE3_MAX_VELOCITY_MPS);
    }
    else
    {
