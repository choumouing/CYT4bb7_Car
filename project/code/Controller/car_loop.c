...
static void car_loop_100HZ(void)
{
    ...
    wifi_justfloat(g_air_tof_fused_height_mm,//0
                   g_air_euler_yaw,
                   (float)car_mode_get(),
                   ...
                   g_car_mode2_state.feedback_forward_mps,
                   g_car_mode2_state.feedback_strafe_mps,
                   ...
                   g_car_mode2_state.car_position_x,
                   g_car_mode2_state.car_position_y,
